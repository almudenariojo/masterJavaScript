...
function estampar(logo) {
    return function (constructor) {
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.estampacion = function () {
...
var Camiseta = function () {
    var _classDecorators = [estampar('Gucci gant')];
    ...
    var Camiseta = _classThis = /** @class */ (function () {
        ...
        Camiseta_1.prototype.setColor = function (color) {
            this.color = color;
            return "El color se ha establecido a: ".concat(color);
        };
...
var CamisetaEstampada = estampar('Gucci gant')(Camiseta);
// Crear una variable de tipo CamisetaEstampada con el decorador aplicado
var camisetaEstampada = new CamisetaEstampada("Azul", "Manga corta", "Nike", "L", 12);
